...
public class Constants {
	...
	// INSERT
	public static String INSERT_ADMIN = "INSERT INTO Admin (cedula,nombre,usuario,password) values('1053852663','David Piedrahita','davipigi','$2a$10$XcF.36e1qihcceWiNduUCutZSzHIBav7ap/aUehTJJdumQgLDCEQi');";
