...
public class UserDetailsImpl implements UserDetails {
	...
	public UserDetailsImpl(String nombre,String usuario, String password, Collection<? extends GrantedAuthority> authorities) {
		this.nombre = nombre;
	...
	public static UserDetailsImpl build(AdminConfiguration admin) {
		...
		return new UserDetailsImpl(admin.getNombre(),admin.getUsuario(), admin.getPassword(), authorities);
	}
